...
f1 = open("fish_human_final_candidate.txt","r")
gene_dict = {}
...
humanGCtranscript = []
f5 = open("human_selected_transcripts.txt","r")
...
for seq_record in SeqIO.parse("humanProtein.fasta","fasta"):
	...
	if human_transcript in humanGCtranscript:
		...
		if human_seq.isupper():
			...
			f3.close()
			for seq_record in SeqIO.parse("zebrafishProtein.fasta","fasta"):
				f4 = open("fish_intermediate.fasta","w")
